...
[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(0.009, 0.07, zadj, runsize, jac_col);
...
save ('P_resumed_Logistic' + date() + nowtime +'.sav', runtime,  adj, detect, op_nt1, op_nt2, avt1_nt1, avt1_nt2, op_mt1, op_mt2, avt1_mt1, avt1_mt2);
