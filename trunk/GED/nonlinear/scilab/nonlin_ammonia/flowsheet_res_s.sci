...
res(14) = (Q_heater1 - flows(3)*(comps(1,3)*Cp_t(1) + comps(2,3)*Cp_t(2) + comps(3,3)*Cp_t(3) + comps(4,3)*Cp_t(4) + comps(5,3)*Cp_t(5) )*(temper(4)-temper(3)))/10;
...
res(27) = (Q_heater2 - flows(5)*(-h2+h1))/10;
