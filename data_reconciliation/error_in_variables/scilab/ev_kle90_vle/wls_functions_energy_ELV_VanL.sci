...
function [nc, nv, nnzjac, nnz_hess, sparse_dg, sparse_dh, lower, upper, var_lin_type, constr_lin_type, constr_lhs, constr_rhs]  = wls_structure_ELV_VanL(xx)
// Data Reconciliation Benchmark Problems From Literature Review
// Author: Edson Cordeiro do Valle
// Contact - edsoncv@{gmail.com}{vrtech.com.br}
// Skype: edson.cv
...
lower = xm(:) - 2.5.* stdDevAllrow;
lower = [lower; 1;1];

upper = xm(:) + 2.5.* stdDevAllrow;
...
constr_lhs(1:2*ndata) = 0;
constr_rhs(1:2*ndata) = 0;
