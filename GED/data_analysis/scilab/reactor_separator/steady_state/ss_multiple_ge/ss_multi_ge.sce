...
scenario = 4
    if scenario == 1 then
        // bias in stream 1 (magnitude = +5) and stream 5 (magnitude = -3)
    
        xcos('serial_steady_multi_ge_1.zcos');
        sleep(2000)
        importXcosDiagram('serial_steady_multi_ge_1.zcos');
    
    elseif scenario == 2  then
        // bias in stream 3 (magnitude = -4) and stream 6 (magnitude = 3)
        xcos('serial_steady_multi_ge_2.zcos');
    sleep(2000)
        importXcosDiagram('serial_steady_multi_ge_2.zcos');
   

    elseif scenario == 3 then
        // bias in stream 1 (magnitude = +4) and leaking in equipment 2  (magnitude = 4)
        xcos('serial_steady_multi_ge_3.zcos');
        sleep(2000)        
        importXcosDiagram('serial_steady_multi_ge_3.zcos');
        
    else
        // bias in stream 4 (magnitude = -4) and leaking in equipment 1 (magnitude = 3)
        xcos('serial_steady_multi_ge_4.zcos');
        sleep(2000)
        importXcosDiagram('serial_steady_multi_ge_4.zcos');
