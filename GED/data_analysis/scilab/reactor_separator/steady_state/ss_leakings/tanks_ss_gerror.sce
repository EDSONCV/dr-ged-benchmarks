...
if run_new ==1 then
    ...
    xcos('serial_steady_state_with_gerror_tst2.zcos');
    importXcosDiagram('serial_steady_state_with_gerror_tst2.zcos');
    scicos_simulate(scs_m);
//    savematfile('-mat','serialrror_mat.sav', 'serial_sum_inlet', 'serial_outlet_tanks','serial_inlet_tanks','-v6');
else
    loadmatfile('-mat','serialrror_mat.sav', 'serial_sum_inlet', 'serial_outlet_tanks','serial_inlet_tanks','-v6');
