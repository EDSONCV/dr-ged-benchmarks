...
const_stream = 4
    if const_stream == 1 then
        ...
        xcos('serial_steady_const_bias_s1.zcos');
        importXcosDiagram('serial_steady_const_bias_s1.zcos');
    
    elseif const_stream == 2  then
        
        xcos('serial_steady_const_bias_s2.zcos');
        importXcosDiagram('serial_steady_const_bias_s2.zcos');
       

    elseif const_stream == 3 then
        xcos('serial_steady_const_bias_s3.zcos');
        importXcosDiagram('serial_steady_const_bias_s3.zcos');

        
    elseif const_stream == 4 then
        xcos('serial_steady_const_bias_s4.zcos');
        importXcosDiagram('serial_steady_const_bias_s4.zcos');

    elseif const_stream == 5 then
        xcos('serial_steady_const_bias_s5.zcos');
        importXcosDiagram('serial_steady_const_bias_s5.zcos');

    else
        xcos('serial_steady_const_bias_s6.zcos');
        importXcosDiagram('serial_steady_const_bias_s6.zcos');
