...
// if you face problems with scilab 5.4, load a previoulsy saved result
    ...
    if drift_stream == 1 then
        ...
        xcos('serial_dyn_drift_bias_s1.zcos');
        importXcosDiagram('serial_dyn_drift_bias_s1.zcos');
    
    elseif drift_stream == 2  then
        
        xcos('serial_dyn_drift_bias_s2.zcos');
        importXcosDiagram('serial_dyn_drift_bias_s2.zcos');
       

    elseif drift_stream == 3 then
        xcos('serial_dyn_drift_bias_s3.zcos');
        importXcosDiagram('serial_dyn_drift_bias_s3.zcos');

        
    elseif drift_stream == 4 then
        xcos('serial_dyn_drift_bias_s4.zcos');
        importXcosDiagram('serial_dyn_drift_bias_s4.zcos');

    elseif drift_stream == 5 then
        xcos('serial_dyn_drift_bias_s5.zcos');
        importXcosDiagram('serial_dyn_drift_bias_s5.zcos');

    else
        xcos('serial_dyn_drift_bias_s6.zcos');
        importXcosDiagram('serial_dyn_drift_bias_s6.zcos');
