...
eqp_leak = 1
    if eqp_leak == 1 then
        ...
        xcos('serial_dyn_leak_e1.zcos');
        importXcosDiagram('serial_dyn_leak_e1.zcos');
    
    elseif eqp_leak == 2  then
        
        xcos('serial_dyn_leak_e2.zcos');
        importXcosDiagram('serial_dyn_leak_e2.zcos');
  

    else
        xcos('serial_dyn_leak_e3.zcos');
        importXcosDiagram('serial_dyn_leak_e3.zcos');
