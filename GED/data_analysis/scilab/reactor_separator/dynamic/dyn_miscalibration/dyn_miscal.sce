...
const_stream = 1
    if const_stream == 1 then
        ...
        xcos('serial_dyn_miscal_s1.zcos');
        importXcosDiagram('serial_dyn_miscal_s1.zcos');
    
    elseif const_stream == 2  then
        
        xcos('serial_dyn_miscal_s2.zcos');
        importXcosDiagram('serial_dyn_miscal_s2.zcos');
       

    elseif const_stream == 3 then
        xcos('serial_dyn_miscal_s3.zcos');
        importXcosDiagram('serial_dyn_miscal_s3.zcos');

        
    elseif const_stream == 4 then
        xcos('serial_dyn_miscal_s4.zcos');
        importXcosDiagram('serial_dyn_miscal_s4.zcos');

    elseif const_stream == 5 then
        xcos('serial_dyn_miscal_s5.zcos');
        importXcosDiagram('serial_dyn_miscal_s5.zcos');

    else
        xcos('serial_dyn_miscal_s6.zcos');
        importXcosDiagram('serial_dyn_miscal_s6.zcos');
