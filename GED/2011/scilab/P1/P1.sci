...
//clear xm sd jac nc nv i1 i2 nonz sparse_dg sparse_dh lower upper var_lin_type constr_lin_type constr_lhs constr_rhs

function [x_sol, f_sol, status]=P1(xm, sd)
...
//params = add_param(params,"constr_viol_tol",1e-6);
params = add_param(params,"mu_strategy","adaptative");
