...
// Overall Power
op_gt = length(ge_gt_new_removed )./(runsize*jac_col- length(ge_gt_remove_index));
//Nodal test
...
[ge_nt_alt_i,ge_nt_alt_j]=find(zr_nt_alt>norm_nt1);
//Measurement test
[ge_mt_i,ge_mt_j]=find(zadj>norm_nt1);
