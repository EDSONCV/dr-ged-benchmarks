...
//[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(0.00015, 0.002, zadj, runsize, jac_col)
//[avt1_nt1, avt1_nt2, op_nt1, op_nt2] = nodal_test(0.0117, 0.09, jac_row, runsize, zr_nt_nodal);
// sigma = 0.7
//[avti_gt_mt, op_gt_mt, op_gt_nt] = global_test(0.1, 0.1, gamaMeasuremts, runsize, rj, jac_col, jac_row);
//[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(0.0004, 0.005, zadj, runsize, jac_col)
//[avt1_nt1, avt1_nt2, op_nt1, op_nt2] = nodal_test(0.0117, 0.09, jac_row, runsize, zr_nt_nodal);
//
// sigma = 0.5
[avti_gt_mt, op_gt_mt, op_gt_nt] = global_test(0.095, 0.095, gamaMeasuremts, runsize, rj, jac_col, jac_row)
[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(0.00025, 0.0035, zadj, runsize, jac_col)
[avt1_nt1, avt1_nt2, op_nt1, op_nt2] = nodal_test(0.015, 0.12, jac_row, runsize, zr_nt_nodal)
...
//cauchy  sigma = 1
//alfa_gt_mt = 0.1; alfa_gt_nt = 0.1; alfa_mt1 = 0.00015; alfa_mt2 =0.002; alfa_nt1 = 0.0117; alfa_nt2 = 0.09;

//cauchy  sigma = 0.7
//alfa_gt_mt = 0.1; alfa_gt_nt = 0.1; alfa_mt1 = 0.0004; alfa_mt2 =0.005; alfa_nt1 = 0.0117; alfa_nt2 = 0.09;

//cauchy  sigma = 0.5
alfa_gt_mt = 0.095; alfa_gt_nt =0.095; alfa_mt1 = 0.00025; alfa_mt2 =0.0035; alfa_nt1 = 0.015; alfa_nt2 = 0.12;

is_multi = 0;
pause
clear res gamaMeasuremts gamaNodal zr_nt_nodal zr_nt_nodal_rand zadj x_sol resGrossErrorNodalRandFi;
[p10_train, p10_validate]  = generate_trainning2(xr, sd, jac, runsize, nvalidate, lower_bias, delta_bias, upper_bias, lower_leak,delta_leak,upper_leak, alfa_gt_mt,alfa_gt_nt,alfa_mt1,alfa_mt1, alfa_nt1, alfa_nt2,obj_function_type, is_multi);
ndatainterval = 5;
[list_models_P10,p10_stat] = generate_pls_models_m( 'P10', 13, 8, p10_train, p10_validate, nvalidate,ndatainterval);
[avti_meas, op_meas, selectivity_meas, aee_meas, avti_eqp, op_eqp, selectivity_eqp, aee_eqp] = get_lit_info(p10_stat, jac_col, jac_row)
