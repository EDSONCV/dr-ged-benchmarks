...
measured_P7 = setdiff([1:length(xr)], umeas_P7);
red = measured_P7;//
...
//
////wls
////[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(0.0114, 0.11, zadj, runsize, jac_col); 
////cauchy
[avti_gt_mt, op_gt_mt, op_gt_nt] = global_test(0.12, 0.12, gamaMeasuremts, runsize, rj, jac_col, jac_row);
[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(0.0006, 0.0055, zadj, runsize, jac_col);
//
...
//nvalidate = 10; lower_bias = 5; delta_bias = 1; upper_bias = 9; lower_leak = 0.15; delta_leak = 0.02; upper_leak = 0.21 ; 
nvalidate = 10; lower_bias = 5; delta_bias = 1; upper_bias = 9; lower_leak = 0.07; delta_leak = 0.02; upper_leak = 0.15; 
//Wls 
//alfa_gt_mt = 0.1; alfa_gt_nt = 0.1; alfa_mt1 = 0.0114; alfa_mt2 =0.11; alfa_nt1 = 0.0193; alfa_nt2 = 0.11;
//Cauchy
//[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(0.00035, 0.0035, zadj, runsize, jac_col)
alfa_gt_mt = 0.12; alfa_gt_nt = 0.12; alfa_mt1 = 0.0006; alfa_mt2 =0.0055; alfa_nt1 = 0.0193; alfa_nt2 = 0.11;
is_multiple = 0;

pause
clear res gamaMeasuremts gamaNodal zr_nt_nodal zr_nt_nodal_rand zadj x_sol resGrossErrorNodalRandFi;
[p7_train, p7_validate]  = generate_trainning2(xr, sd, jac, runsize, nvalidate, lower_bias, delta_bias, upper_bias, lower_leak,delta_leak,upper_leak, alfa_gt_mt,alfa_gt_nt,alfa_mt1,alfa_mt1, alfa_nt1, alfa_nt2,obj_function_type,is_multiple);
ndatainterval = 5
[list_models_P7, p7_stat] = generate_pls_models_m( 'P7', 10, 6, p7_train, p7_validate, nvalidate,ndatainterval);
[avti_meas, op_meas, selectivity_meas, aee_meas, avti_eqp, op_eqp, selectivity_eqp, aee_eqp] = get_lit_info(p7_stat, jac_col, jac_row) 
