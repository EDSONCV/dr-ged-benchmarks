...
//[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(0.01122, 0.088, zadj, runsize, jac_col);
//cauchy
[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(0.00065, 0.0053, zadj, runsize, jac_col);
...
//cauchy 
alfa_gt_mt = 0.12; alfa_gt_nt = 0.12; alfa_mt1 = 0.00065; alfa_mt2 =0.0053; alfa_nt1 = 0.028; alfa_nt2 = 0.107;
pause
is_multiple = 0;
clear res gamaMeasuremts gamaNodal zr_nt_nodal zr_nt_nodal_rand zadj x_sol resGrossErrorNodalRandFi;
[p5_train, p5_validate]  = generate_trainning2(xr, sd, jac, runsize, nvalidate, lower_bias, delta_bias, upper_bias, lower_leak,delta_leak,upper_leak, alfa_gt_mt,alfa_gt_nt,alfa_mt1,alfa_mt1, alfa_nt1, alfa_nt2,obj_function_type,is_multiple);
ndatainterval = 5
[list_models_P5,p5_stat] = generate_pls_models_m( 'P5', 8, 4, p5_train, p5_validate, nvalidate,ndatainterval);

[avti_meas, op_meas, selectivity_meas, aee_meas, avti_eqp, op_eqp, selectivity_eqp, aee_eqp] = get_lit_info(p5_stat, jac_col, jac_row)  
runtime=toc();
