...
[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(6E-5, 1.6E-3, zadj, runsize, jac_col)
[avt1_nt1, avt1_nt2, op_nt1, op_nt2] = nodal_test(0.9E-2, 1.3E-1, jac_row, runsize, zr_nt_nodal)
...
pause
alfa_gt_mt = 0.13; alfa_gt_nt =0.13; alfa_mt1 = 6E-5; alfa_mt2 =1.6-3; alfa_nt1 = 0.9E-2; alfa_nt2 =1.3E-1;
nvalidate = 7; lower_bias = 5; delta_bias = 1; upper_bias = 9; lower_leak = 0.07; delta_leak = 0.02; upper_leak = 0.15; 



// cauchy sigma = 1 P_16
//[avti_gt_mt, op_gt_mt, op_gt_nt] = global_test(0.08, 0.08, gamaMeasuremts, runsize, rj, jac_col, jac_row)
//[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(3.5E-5, 0.9E-3, zadj, runsize, jac_col)
//[avt1_nt1, avt1_nt2, op_nt1, op_nt2] = nodal_test(5E-3, 0.7E-1, jac_row, runsize, zr_nt_nodal)
//
////[avti_glr, op_glr_mt, aee_mt, aee_nt, op_glr_nt, avti_glr_nt ]=calc_GLR(res, V_inv, xfinal, jac, sigma, resGrossErrorNodalRandFi, 0.135, 0.21, runsize);
//pause
//alfa_gt_mt = 0.08; alfa_gt_nt =0.08; alfa_mt1 = 3.5E-5; alfa_mt2 =0.9E-3; alfa_nt1 = 5E-3; alfa_nt2 =0.7E-1;
//nvalidate = 7; lower_bias = 5; delta_bias = 1; upper_bias = 9; lower_leak = 0.07; delta_leak = 0.02; upper_leak = 0.15; 
//
...
//[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(3.8E-5, 1E-3, zadj, runsize, jac_col)
//[avt1_nt1, avt1_nt2, op_nt1, op_nt2] = nodal_test(6.5E-3, 0.93E-1, jac_row, runsize, zr_nt_nodal)
//
////[avti_glr, op_glr_mt, aee_mt, aee_nt, op_glr_nt, avti_glr_nt ]=calc_GLR(res, V_inv, xfinal, jac, sigma, resGrossErrorNodalRandFi, 0.135, 0.21, runsize);
//pause
//alfa_gt_mt = 0.1; alfa_gt_nt =0.1; alfa_mt1 = 3.8E-5; alfa_mt2 =1E-3; alfa_nt1 = 6.5E-3; alfa_nt2 =0.93E-1;
