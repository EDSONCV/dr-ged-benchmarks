...
//[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(4E-5, 1.5E-3, zadj, runsize, jac_col)
...
//pause
//alfa_gt_mt = 0.08; alfa_gt_nt =0.08; alfa_mt1 = 4E-5; alfa_mt2 =1.5E-3; alfa_nt1 = 6E-3; alfa_nt2 =1.05E-1;
...
//[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(0.2E-4, 5E-4, zadj, runsize, jac_col)
//[avt1_nt1, avt1_nt2, op_nt1, op_nt2] = nodal_test(6.4E-3, 0.11, jac_row, runsize, zr_nt_nodal)
////
//////[avti_glr, op_glr_mt, aee_mt, aee_nt, op_glr_nt, avti_glr_nt ]=calc_GLR(res, V_inv, xfinal, jac, sigma, resGrossErrorNodalRandFi, 0.135, 0.21, runsize);
////pause
//alfa_gt_mt = 0.105; alfa_gt_nt =0.105; alfa_mt1 =0.2E-4; alfa_mt2 =5E-4; alfa_nt1 = 6.4E-3; alfa_nt2 =0.11;
//nvalidate = 5; lower_bias = 5; delta_bias = 1; upper_bias = 9; lower_leak = 0.07; delta_leak = 0.02; upper_leak = 0.15; 
// pause
