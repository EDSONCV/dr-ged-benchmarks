...
szx = size(xr,1);
runsize = 2500;
sd = [0.902;0.902;0.835;0.819;0.912;0.876;0.854;0.787;];
sds = sd;
var=sd.^2;
...
[avti_glr, op_glr_mt, aee_mt, aee_nt, op_glr_nt, avti_glr_nt ]=calc_GLR(res, V_inv, xfinal, jac, sigma, resGrossErrorNodalRandFi, 0.19, 0.25, runsize)

[avti_gt_mt, op_gt_mt, op_gt_nt] = global_test(0.1, 0.1, gamaMeasuremts, runsize, rj, jac_col, jac_row)

[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(0.025, 0.19, zadj, runsize, jac_col)

[avt1_nt1, avt1_nt2, op_nt1, op_nt2] = nodal_test(0.03, 0.125, jac_row, runsize, zr_nt_nodal)



runtime=toc();
streamNames = 'S405 S407 S408 S453 S460 S456 S452 S411';
...
eqpNames = "452-448 DA-408 DA-402 ";
