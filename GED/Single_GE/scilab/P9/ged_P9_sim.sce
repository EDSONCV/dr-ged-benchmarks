...
[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(0.0134, 0.15, zadj, runsize, jac_col);

[avt1_nt1, avt1_nt2, op_nt1, op_nt2] = nodal_test(0.021, 0.116, jac_row, runsize, zr_nt_nodal);

[avti_glr, op_glr_mt, aee_mt, aee_nt, op_glr_nt, avti_glr_nt ]=calc_GLR(res, V_inv, xfinal, jac, sigma, resGrossErrorNodalRandFi, 0.15, 0.23, runsize);

// For robust tests
//
//[avti_gt_mt, op_gt_mt, op_gt_nt] = global_test(0.1, 0.1, gamaMeasuremts, runsize, rj, jac_col, jac_row);
//
//[avt1_mt1, avt1_mt2, op_mt1, op_mt2] = measurement_test(0.0000145, 0.00017, zadj, runsize, jac_col);
//
//[avt1_nt1, avt1_nt2, op_nt1, op_nt2] = nodal_test(0.021, 0.116, jac_row, runsize, zr_nt_nodal);
//
//[avti_glr, op_glr_mt, aee_mt, aee_nt, op_glr_nt, avti_glr_nt ]=calc_GLR(res, V_inv, xfinal, jac, sigma, resGrossErrorNodalRandFi, 0.15, 0.23, runsize);
