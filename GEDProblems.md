...
```
  ...
  * Lower and upper bound for leakings gross error generation, see the simulation file for information. lb\_leak and ub\_leak must be divided by 100 in gererate\_data function.
